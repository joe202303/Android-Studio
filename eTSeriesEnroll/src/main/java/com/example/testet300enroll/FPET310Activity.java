...
public class FPET310Activity extends Activity {

	private static final String TAG = "FPET310Activity";
	...
	private void setEnrollView(String enrollID){
		...
		*/
		//FPET310CFragment fr = new FPET310CFragment();
		FPET310CFragment fr = new FPET310CFragment(casename, filename, fingernumber, cansaveimage, imagecount);
		fr.setEnrollId(enrollID);
		getFragmentManager().beginTransaction().add(R.id.container, fr).commit();
